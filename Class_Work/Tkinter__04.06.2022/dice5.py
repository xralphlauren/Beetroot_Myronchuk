...
def throw():
    ...
    for i in range(int(kolvo.get())):
        ...
        lbls.append(ttk.Label(fr, text=di[dice], font=("", 30)))
        lbls[-1].grid(row=0, column=i)
...
fr = ttk.Frame(root, width=400, height=200, border=2, relief='ridge')
fr.grid(column=0, columnspan=4, row=1, sticky='WE')
